...
$deployTokenFromEnvFile = function (): ?string {
...
$deployAuthorized = function (string $token) use ($deployTokenFromEnvFile): void {
    $deployToken = env('DEPLOY_TOKEN') ?: $deployTokenFromEnvFile();
